...
4. [Hardware Setup](#hardware)
4. [Running in Real World](#deployment)
...
#### Assemble the manipulators
   ...
   <img src="source/manipulators.png" alt="manipulators" width=80%/>
   ...
   <img src="source/left_manipulator_fabrication.png" alt="left_manipulator_fabrication" width=80%/>
   ...
   <img src="source/left_manipulator_urdf.png" alt="left_manipulator_urdf" width=80%/>
...
<img src="source/deployment.png" alt="deployment" width=100%/>
